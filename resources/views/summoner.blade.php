													...
													<div class="Stats" style="display:table-cell;vertical-align: middle; padding-left: 6px; padding-right: 6px">
														...
														@if ($targetSummoner[$key][$summoner->name] <= 5)
															...
															@if (array_sum($totalKills100[$key]) > 0)
																<div class="Kill Participation">{{round(($match->participants[$targetSummoner[$key][$summoner->name]]->stats->kills / array_sum($totalKills100[$key]) * 100)), 2}}% KP</div>
															@else
														...
														@else
															...
															@if (array_sum($totalKills200[$key]) > 0)
																<div class="Kill Participation">{{round($match->participants[$targetSummoner[$key][$summoner->name]]->stats->kills / array_sum($totalKills200[$key]) * 100), 2}}% KP</div>
															@else
